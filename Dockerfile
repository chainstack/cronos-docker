...
RUN cd /tmp && wget --no-check-certificate https://crypto-org-mainnet-fullnode-backup.s3.ap-southeast-1.amazonaws.com/cronos-v1.0.11-hotfix/cronos-v1.0.11-hotfix-x86_64.tar.gz && tar -xvf cronos-v1.0.11-hotfix-x86_64.tar.gz \
    && rm cronos-v1.0.11-hotfix-x86_64.tar.gz && mv ./* /home/cronos/
