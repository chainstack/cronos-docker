...
RUN cd /home/cronos && wget --no-check-certificate https://github.com/crypto-org-chain/cronos/releases/download/v0.6.11/cronos_0.6.11_Linux_x86_64.tar.gz && tar -xvf cronos_0.6.11_Linux_x86_64.tar.gz \
    && rm cronos_0.6.11_Linux_x86_64.tar.gz
