...
RUN cd /tmp && wget --no-check-certificate https://github.com/crypto-org-chain/cronos/releases/download/v1.4.3/cronos_1.4.3_Linux_x86_64.tar.gz && tar -xvf cronos_1.4.3_Linux_x86_64.tar.gz \
    && rm cronos_1.4.3_Linux_x86_64.tar.gz && mv ./* /home/cronos/
