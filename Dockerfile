...
RUN cd /tmp && wget --no-check-certificate https://github.com/crypto-org-chain/cronos/releases/download/v1.0.12/cronos_1.0.12_Linux_x86_64.tar.gz && tar -xvf cronos_1.0.12_Linux_x86_64.tar.gz \
    && rm cronos_1.0.12_Linux_x86_64.tar.gz && mv ./* /home/cronos/
