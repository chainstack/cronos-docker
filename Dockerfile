...
RUN cd /tmp && wget --no-check-certificate https://github.com/crypto-org-chain/cronos/releases/download/v0.6.10/cronos_0.6.10_Linux_x86_64.tar.gz && tar -xvf cronos_0.6.10_Linux_x86_64.tar.gz \
    && rm cronos_0.6.10_Linux_x86_64.tar.gz && mv ./* /home/cronos/
