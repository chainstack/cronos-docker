...
RUN cd /home/cronos && wget --no-check-certificate https://github.com/crypto-org-chain/cronos/releases/download/v0.8.3/cronos_0.8.3-testnet_Linux_x86_64.tar.gz && tar -xvf cronos_0.8.3-testnet_Linux_x86_64.tar.gz \
    && rm cronos_0.8.3-testnet_Linux_x86_64.tar.gz
