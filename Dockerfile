...
RUN cd /home/cronos && wget --no-check-certificate https://github.com/crypto-org-chain/cronos/releases/download/v1.4.0-rc4/cronos_1.4.0-rc4-testnet_Linux_x86_64.tar.gz && tar -xvf cronos_1.4.0-rc4-testnet_Linux_x86_64.tar.gz \
    && rm cronos_1.4.0-rc4-testnet_Linux_x86_64.tar.gz
